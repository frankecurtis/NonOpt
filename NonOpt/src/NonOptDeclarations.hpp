...
DECLARE_EXCEPTION(NONOPT_INITIALIZATION_FAILURE_EXCEPTION);
...
DECLARE_EXCEPTION(NONOPT_FUNCTION_EVALUATION_ASSERT_EXCEPTION);
DECLARE_EXCEPTION(NONOPT_GRADIENT_EVALUATION_ASSERT_EXCEPTION);
...
DECLARE_EXCEPTION(NONOPT_INVERSE_HESSIAN_UPDATE_FAILURE_EXCEPTION);
...
/**
 * Inverse Hessian update exceptions
 */
DECLARE_EXCEPTION(IH_SUCCESS_EXCEPTION);
DECLARE_EXCEPTION(IH_EVALUATION_FAILURE_EXCEPTION);
DECLARE_EXCEPTION(IH_NORM_TOLERANCE_VIOLATION_EXCEPTION);
DECLARE_EXCEPTION(IH_PRODUCT_TOLERANCE_VIOLATION_EXCEPTION);
/**
