...
//                 f(x) = max{sum_{i=1..n-1} (x_i^4 + x_{i+1}^2),
//                            sum_{i=1..n-1} ((2-x_i)^2 + (2-x_{i+1})^2),
//                            sum_{i=1..n-1} (2*exp(-x_i+x_{i+1}))}
//               with initial point
//                 x_i = 2.0 for all i = 1..n
// Notes       : THIS PROBLEM IS CONVEX
//               Optimal value: 2*(n-1)

#ifndef __CHAINEDCB3_2_HPP__
#define __CHAINEDCB3_2_HPP__
 ...
 * ChainedCB3_2 class
 */
class ChainedCB3_2 : public Problem
{
...
private:
   ...
   * Copy constructor
   */
  ChainedCB3_2(const ChainedCB3_2&);
  /**
   * Overloaded equals operator
   */
  void operator=(const ChainedCB3_2&);
  //@}
