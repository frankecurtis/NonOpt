...
//                 f(x) = sum_{i=1..n-1}
//                          max{-x_i-x_{i+1},
//                              -x_i-x_{i+1}+(x_i^2+x_{i+1}^2-1)}
//               with initial point
//                 x_i = -0.5 for all i = 1..n
// Notes       : THIS PROBLEM IS CONVEX
//               Optimal value: -(n-1)*sqrt(2)

#ifndef __CHAINEDLQ_HPP__
#define __CHAINEDLQ_HPP__
 ...
 * ChainedLQ class
 */
class ChainedLQ : public Problem
{
