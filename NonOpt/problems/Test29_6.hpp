...
//                 f(x) = max_{i=1..n} |(3-2*x[i])*x[i] + 1 - x[i-1] - x[i+1]|
//               where
//                 x_0 = x_{n+1} = 0.0
//               with initial point
...
#ifndef __TEST29_6_HPP__
#define __TEST29_6_HPP__
...
private:
   ...
   * Copy constructor
   */
  Test29_6(const Test29_6&);
  /**
   * Overloaded equals operator
   */
  void operator=(const Test29_6&);
  //@}
